...
par(mfrow=c(2,2),mar=c(2,2,2,4),oma=c(2,2,2,4))
plotcormap(cormap(CARBON_GIOP,MLD),lab='a) MLD vs. Carbon')
plotcormap(cormap(CHL_GIOP,MLD),lab='b) MLD vs. Chlorophyll')
image.plot(matrix(c(-1,1)),legend.only=TRUE,col=brewer.pal(n=9,name='RdBu'),legend.line=2)
plotcormap(cormap(CARBON_GIOP,I),lab='c) MLD-averaged Irradiance vs. Carbon')
plotcormap(cormap(CHL_GIOP,I),lab='d) MLD-averaged Irradiance vs. Chlorophyll')
...
image.plot(matrix(c(0,1)),legend.only=TRUE,col=brewer.pal(n=9,name='RdBu'),legend.line=2)
plotcormap(cormap(CARBON_GIOP[,,soda_i],I_soda),lab='c) MLD-averaged Irradiance vs. Carbon')
plotcormap(cormap(CHL_GIOP[,,soda_i],I_soda),lab='d) MLD-averaged Irradiance vs. Chlorophyll')
mtext(side=1,outer=TRUE,line=0.5,'Longitude',cex=1.2)
mtext(side=2,outer=TRUE,line=0.5,'Latitude',cex=1.2)
dev.off()
